...
# відкриття файлу з даними про оплати клієнтів, порівняння з базою клієнтів дилерів; знайдені оплати зберігаються у вигляді словника
...
# вивантаження даних роботи функції 'add_more_diler_info' у файл Ексель; дані будуть збережені у файл 'result_paid_customers.xlsx'; дані, які треба продублювати - підкреслюються
